		...
		<div class="d-flex flex-column">
			<div class="profile">
				...
				<div class="social-links mt-4 text-center">
					<NuxtLink
						:href="$t('general.profile.socialUrl.twitter')"
						class="twitter"
						target="_bank"
					>
					...
					<NuxtLink
						:href="$t('general.profile.socialUrl.github')"
						class="github"
						target="_bank"
					>
					...
					<ul>
						<li>
							<NuxtLink href="#about" class="nav-link scrollto" @click="submitScrollTo">
								...
								><span>{{ $t("general.mainMenu.about") }}</span>
							</NuxtLink>
						</li>
						<li>
							<NuxtLink
								...
								@click="submitScrollTo"
							>
								<i class="fa-solid fa-person-digging me-2"></i
								><span>{{ $t("general.mainMenu.experience") }}</span>
							</NuxtLink>
						</li>
						<li>
							<NuxtLink
