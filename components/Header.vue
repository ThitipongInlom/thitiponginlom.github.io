<template>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            <div class="profile">
                <img src="~/assets/image/general/thitiponginlom.jpg" alt="Image Profile Resume" class="img-fluid rounded-circle profile">
                <h1 class="text-light">
                    <NuxtLink to="/">
                ...
                <div class="social-links mt-4 text-center">
                    ...
                    <NuxtLink :href="$t('general.profile.socialUrl.facebook')" class="facebook" target="_bank">
                        <i class="fa-brands fa-facebook"></i>
                    </NuxtLink>
                    <NuxtLink :href="$t('general.profile.socialUrl.instagram')" class="instagram" target="_bank">
                        <i class="fa-brands fa-instagram"></i>
                    </NuxtLink>
                    <NuxtLink :href="$t('general.profile.socialUrl.github')" class="github" target="_bank">
                        <i class="fa-brands fa-github"></i>
                    </NuxtLink>
                    <NuxtLink :href="$t('general.profile.socialUrl.linkedin')" class="linkedin" target="_bank">
                ...
                <div class="language row">
                    <div class="col-6 text-center mt-3">
                        <div class="d-grid gap-2">
                            <NuxtLink class="btn btn-outline-info" :class="{ active: activeClassButtonEnglishLang }" @click="switcherLanguage('en')" href="javascript:void(0)" role="button">
                                <img src="~/assets/image/lang/english.png" width="20" alt="English language" class="img-fluid rounded">
                    ...
                    <div class="col-6 text-center mt-3">
                        <div class="d-grid gap-2">
                            <NuxtLink class="btn btn-outline-info" :class="{ active: activeClassButtonThaiLang }" @click="switcherLanguage('th')" href="javascript:void(0)" role="button">
                                <img src="~/assets/image/lang/thai.png" width="20" alt="Thailand language" class="img-fluid rounded">
